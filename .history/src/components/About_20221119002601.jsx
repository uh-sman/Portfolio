        ...
        <div className="about-side">
          <div className="about-myself">
            <p className="text">
              ...
              Ilorin, Kwarar State, Nigeria. But I work remotely for
              international clients.
            </p>
            <p className="text">
              I started creating web designs using HTML and CSS back in 2018. I
              am a JavaScript enthusiast and extremely passionate about coding.
              I love to learn and create new things everyday and keep updated
              with new technologies. I find passion with coding
            </p>
            <p className="text">
